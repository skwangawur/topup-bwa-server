  ...
  checkout: async (req, res) => {
    try {
      ...
      const res_voucher = await Voucher.findOne({ _id: voucher })
        .select("name category _id user thumbnail")
        .populate("category")
        .populate("user");
      ...
      const payload = {
        ...
        historyPayment: {
          name: res_bank._doc.author,
          type: res_payment._doc.type,
          bankName: res_bank._doc.bankName,
          noRekening: res_bank._doc.bankAccount,
        },
        name: name,
      ...
      await Transaction(payload).save();
    ...
    try {
      ...
      if (req.file) {
        ...
        src.on("end", async () => {
          ...
          const currentImage = `${config.rootPath}/public/images/${player.avatar}`;
